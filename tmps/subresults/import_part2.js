...
const PART_FILE = 'C:/Users/DEX/Proyectos/bioitia/tmps/subresults/SubResultados_part2.csv';
...
async function main() {
    ...
    for await (const line of rl) {
        ...
        if (batch.length >= BATCH_SIZE) {
            ...
            if (inserted % 25000 === 0) {
                console.log(`Lote insertado Parte 2... Llevamos guardados: ${inserted} / ${validRows} leídos.`);
            }
        }
    }
    ...
    console.log(`\n--- IMPORTACIÓN DE PARTE 2 FINALIZADA ---`);
