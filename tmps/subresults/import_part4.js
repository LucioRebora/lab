...
const PART_FILE = 'C:/Users/DEX/Proyectos/bioitia/tmps/subresults/SubResultados_part4.csv';
...
async function main() {
    ...
    for await (const line of rl) {
        ...
        if (batch.length >= BATCH_SIZE) {
            ...
            if (inserted % 20000 === 0) {
                console.log(`Parte 4: Procesado lotes de a ${BATCH_SIZE}. Total: ${inserted} / ${validRows} registros.`);
            }
        }
    }
    ...
    console.log(`\n--- IMPORTACIÓN DE PARTE 4 COMPLETA ---`);
